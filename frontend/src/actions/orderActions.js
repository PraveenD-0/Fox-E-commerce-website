...
export const createOrder = order => async(dispatch) => {
    try {
       ...
       const {data} = await axios.post(`/api/url/order/new`, order)
...
export const userOrders = async(dispatch) => {
    try {
       ...
       const {data} = await axios.get(`/api/url/myorders`)
...
export const orderDetail = id => async(dispatch) => {
    try {
       ...
       const {data} = await axios.get(`/api/url/order/${id}`)
...
export const adminOrders = async(dispatch) => {
    try {
       ...
       const {data} = await axios.get(`/api/url/admin/orders`)
...
export const deleteOrder = id => async(dispatch) => {
    try {
       ...
       await axios.delete(`/api/url/admin/order/${id}`)
...
export const updateOrder = (id, orderData)  => async(dispatch) => {
    try {
       ...
       const { data} = await axios.put(`/api/url/admin/order/${id}`, orderData)
