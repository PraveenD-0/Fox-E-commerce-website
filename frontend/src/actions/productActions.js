...
export const getProducts = (keyword, price, category, rating, currentPage) => async (dispatch) => {
    try {  
        ...
        let link = `/api/url/products?page=${currentPage}`;
...
export const createReview = reviewData => async (dispatch) => {
    ...
    try {  
        ...
        const { data }  =  await axios.put(`/api/url/review`,reviewData, config);
...
export const getAdminProducts  =  async (dispatch) => {
    ...
    try {  
        ...
        const { data }  =  await axios.get(`/api/url/admin/products`);
...
export const createNewProduct  =  productData => async (dispatch) => {
    ...
    try {  
        ...
        const { data }  =  await axios.post(`/api/url/admin/product/new`, productData);
...
export const deleteProduct  =  id => async (dispatch) => {
    ...
    try {  
        ...
        await axios.delete(`/api/url/admin/product/${id}`);
...
export const updateProduct  =  (id, productData) => async (dispatch) => {
    ...
    try {  
        ...
        const { data }  =  await axios.put(`/api/url/admin/product/${id}`, productData);
...
export const getReviews =  id => async (dispatch) => {
    ...
    try {  
        ...
        const { data }  =  await axios.get(`/api/url/admin/reviews`,{params: {id}});
...
export const deleteReview =  (productId, id) => async (dispatch) => {
    ...
    try {  
        ...
        await axios.delete(`/api/url/admin/review`,{params: {productId, id}});
